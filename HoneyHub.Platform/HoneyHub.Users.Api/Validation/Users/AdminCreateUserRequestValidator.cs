...
/// <summary>
/// FluentValidation validator for AdminCreateUserRequest.
/// Implements technical validation rules for administrative user creation.
...
public class AdminCreateUserRequestValidator : AbstractValidator<AdminCreateUserRequest>
{
    public AdminCreateUserRequestValidator()
    {
        ...
        RuleFor(x => x.Password)
            .NotEmpty()
            .WithMessage("Password is required for admin user creation.")
            .MinimumLength(8)
